...
class FilterDataAttributePipeline(object):
    def process_item(self, item, spider):
        ...
        attribs = [
            ...
            'Thể loại:', 'actors', 'description', 'episodes'
        ]
...
class LinkAdditionPipeline(object):
    def process_item(self, item, spider):
        dummy_link = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4"
        item['episodes'] = {episode: dummy_link for episode in item['episodes']}
        return item
